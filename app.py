...
st.write("Upload MIT-BIH .dat, .atr, and optionally .hea files for ECG analysis, disease risk assessment, and ML classification.")
...
def load_record(record_path, win=WINDOW):
    try:
        # Check .hea, create minimal if missing
